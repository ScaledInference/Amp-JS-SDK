...
``` javascript
<script>
"use strict";!function(n){if(window.ampConfig.instanceName?window.ampInstanceName=window.ampConfig.instanceName:window.ampInstanceName="amp",!window[window.ampInstanceName]){n=n||{},Object.assign(n,window.ampConfig||{}),window[window.ampInstanceName]={replay:[],v:"1.1.0",ts:(new Date).getTime()};for(var e="observe decide log".split(" "),a=0;a<e.length;a++)!function(n){window[window.ampInstanceName][n]=function(){for(var e=arguments.length,a=Array(e),i=0;i<e;i++)a[i]=arguments[i];window[window.ampInstanceName].replay.push([n,a,(new Date).getTime()])}}(e[a]);var i=document,w=i.getElementsByTagName("script")[0],t=i.createElement("script");w.parentNode.insertBefore(t,w),t.type="text/javascript",t.async=!0,t.src=n.scriptSrc||(n.domain||"https://amp.ai")+"/libs/"+(n.key||"amp.min")+".js",t.onload=function(){if(document.dispatchEvent(new Event("AmpLoaded")),"undefined"!=typeof window&&window.amp&&window.amp.replay)try{var n=window.amp.replay;window[window.ampInstanceName].config.set("replayTime",(new Date).getTime()-window.amp.ts),n.forEach(function(n){n[2]&&window[window.ampInstanceName].timing("requestReplay",{method:name,event:n[0],start:n[2]}).end(),window[window.ampInstanceName][n[0]].apply(window[window.ampInstanceName],n[1])}),window[window.ampInstanceName].config.set("replayTime",0)}catch(n){window[window.ampInstanceName].warn(window[window.ampInstanceName].error({name:"UNAVAILABLE",message:"Error replaying amp snippet"}))}}}}({key:"<AMP-PROJECT-KEY>"});
</script>
<script>  
  let color;
  let font;
